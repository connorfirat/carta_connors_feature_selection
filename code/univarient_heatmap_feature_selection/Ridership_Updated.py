...
def univariateSelection(data):
    ...
    y = data.loc[:, ['Net_Passengers_Positive']].values  # dependent variable
...
def featureSelection(data):
    ...
    new = feat_importances.drop(index='Net_Passengers_Positive')
    # print(new)
    # Below, change the nlargest() input to however many variables you want showed
    new.nlargest(18).plot(kind='barh')
...
ridership_data = pandas.read_csv('C:/Users/conno/Desktop/CUIP/CARTA_feature_selection/data/Yatri_Data/Chatt_Ridership_Roads_Fields.csv')
# ridership_data = pandas.read_csv('C:/Users/conno/Desktop/CUIP/CARTA_feature_selection/data/Yatri_Data/Chatt_TAZ_Road_Fields_Updated.csv')
